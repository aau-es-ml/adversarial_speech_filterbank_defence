...
from draugr.writers import TestingScalars, TrainingScalars, should_plot_y_log_scale
                    ...
                    if mapping.is_dir():
                        ...
                        for transformation in progress_bar(
                            ...
                            if transformation.is_dir():
                                ...
                                for seed_ith in progress_bar(a):
                                                ...
                                                if export_mean_mean_confusion_matrix:
                                                    ...
                                                    if export_csvs:
                                                        my_df.to_csv(
                                                            str(
                                                                epath
                                                                / f"{test_set.name}_mean_mean_confusion_matrix.csv"
                                                            ),
                                                            index=True,
                                                        )
                                                    if False:
                                                        with SubplotSession() as cfm_subplot:
                                                            ...
                                                            save_pdf_embed_fig(
                                                                str(
                                                                    epath
                                                                    / f"{test_set.name}_mean_mean_confusion_matrix.pdf"
                                                                )
                                                            )
                                                ...
                                                if export_confusion_matrix:
                                                    ...
                                                    if export_csvs:
                                                        my_df.to_csv(
                                                            str(
                                                                epath
                                                                / f"{test_set.name}_mean_confusion_matrix.csv"
                                                            ),
                                                            index=True,
                                                        )
                                                    if True:
                                                        with SubplotSession(
                                                            ...
                                                            save_pdf_embed_fig(
                                                                str(
                                                                    epath
                                                                    / f"{test_set.name}_mean_confusion_matrix.pdf"
                                                                )
                                                            )
